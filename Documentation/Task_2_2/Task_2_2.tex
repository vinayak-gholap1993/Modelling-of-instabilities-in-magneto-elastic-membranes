...
The resulting discretized system of equations for the final linearised variational form \Cref{eq:3.35} employing the results from \Crefrange{eq:3.26.1}{eq:3.27.2} and \Crefrange{eq:3.30.1}{eq:3.31.2} can be written in the form of the following L.H.S. and R.H.S.:
\begin{align}
