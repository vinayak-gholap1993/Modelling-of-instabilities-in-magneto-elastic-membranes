...
\label{eq:3.37}
\end{align}
The resulting discretized \Cref{eq:3.36,eq:3.37} must hold for all arbitrary variations $\delta \phi_I$ and $\delta u_I$. The algebraic system to be solved at time/load step $t_n$ and Newton iterate $i$ is
\begin{equation}
\begin{bmatrix}
